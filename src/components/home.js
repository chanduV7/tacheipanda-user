...
import { filterJobs, getAllJobs } from "../redux/slices/dataSlice";
...
export default function Home() {
  ...
  // const filteredJobs = useSelector((e) => e.User.value.filteredJobs)
  ...
  return (
    <div
      className="homePage-container bg-white"
    ...
    >
      ...
      <div className="foter">
        <div className="inside">
          ...
          <div className="website">https://techiepanda.in/</div>
          <div className="contact">+91 720 740 1718</div>
          <div className="mid">
            <p>
              <b>Site Map</b>
            </p>
        ...
        <div>
          <iframe
            ...
            style={{ height: "11em", width: "18em", marginTop: "-0.5em" }}
          />
        </div>
      </div>
    </div>
